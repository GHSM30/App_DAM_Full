    ...
    return Controller.extend(
      "com.invertions.sapfiorimodinv.controller.catalogs.Catalogs",
      {
        ...
        onInit: function () {
          ...
          $.ajax({
            url: "http://localhost:3020/api/inv/GetAllCatalogs",
            method: "GET",
...
onSaveCatalog: function () {
  ...
  var payload = {
    ...
    REGUSER: oData.DETAIL_ROW?.DETAIL_ROW_REG?.find(r => r.CURRENT)?.REGUSER || "FIBARRAC"
  };

  console.log("Payload:", payload);

  $.ajax({
    url: "http://localhost:3020/api/inv/CreateCatalog",
    method: "POST",
    ...
    error: function (error) {
      MessageToast.show("Error al guardar: " + error.responseText);
        ...
        onSaveEdit: function () {
          ...
          $.ajax({
            url: "http://localhost:3020/api/inv/UpdateViewByCompanyId",
            method: "POST",
            contentType: "application/json",
            data: JSON.stringify({
              values: oEditedData,
          ...
          MessageBox.confirm("¿Está seguro de eliminar este registro?", {
            ...
            onClose: function (sAction) {
              if (sAction === MessageBox.Action.YES) {
                $.ajax({
                  url: "http://localhost:3020/api/inv/DeleteViewByCompanyId",
                  method: "POST",
                  contentType: "application/json",
